...
@Configuration
@EnableWebMvc
@ComponentScan(basePackages = "org.sakaiproject.videotraining.tool")
public class VideoTrainingWebMvcConfig implements WebMvcConfigurer, ApplicationContextAware {
    ...
    public MessageSource messageSource() {
        ...
        messages.setBasename("bundle.video-training");
        return messages;
    }
